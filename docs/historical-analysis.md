# Historical HG002 analysis

This document records the experiments and results obtained with the original
automated workflow. Its Windows launch commands, checkpoint logic and code paths
refer to [the historical version](https://github.com/AntonelloColangelo/gpu-wgs-variant-calling/tree/f222fdf).
For the current simple Bash workflow, see [the main README](../README.md).
The simplified scripts have not been rerun on a whole genome; the published
metrics below belong to the original runs.
...
![Where the ten and a half hours go](https://github.com/AntonelloColangelo/gpu-wgs-variant-calling/blob/f222fdf/docs/figures/runtime_breakdown.png)
...
![CPU and memory pinned for the whole alignment](https://github.com/AntonelloColangelo/gpu-wgs-variant-calling/blob/f222fdf/docs/figures/host_bottleneck.png)
...
![CPU versus GPU on the same machine](https://github.com/AntonelloColangelo/gpu-wgs-variant-calling/blob/f222fdf/docs/figures/cpu_vs_gpu.png)
...
![SNP false negatives per chromosome, before and after](https://github.com/AntonelloColangelo/gpu-wgs-variant-calling/blob/f222fdf/hg002_snp_false_negatives.png)
...
[docs/iteration-2-plan.md](https://github.com/AntonelloColangelo/gpu-wgs-variant-calling/blob/f222fdf/docs/iteration-2-plan.md); seven of nine predictions held
...
[docs/pipeline-validation-20260725.md](https://github.com/AntonelloColangelo/gpu-wgs-variant-calling/blob/f222fdf/docs/pipeline-validation-20260725.md),
