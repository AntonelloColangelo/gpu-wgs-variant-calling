...
| Sample | Caller | SNP F1 | INDEL F1 | Saved evidence |
|---|---|---:|---:|---|
| HG002 | Parabricks HaplotypeCaller | 0.9921 | 0.9924 | [JSON](reports/giab/HG002_NovaSeq_40x_53007e55/giab_benchmark.json) |
| HG003 | Parabricks HaplotypeCaller | 0.9917 | 0.9913 | [JSON](hg003-deepvariant-vs-gatk/giab/haplotypecaller/giab_benchmark.json) |
| HG003 | Parabricks DeepVariant | 0.9962 | 0.9959 | [JSON](hg003-deepvariant-vs-gatk/giab/deepvariant/giab_benchmark.json) |

The corresponding `happy.summary.csv` files are saved alongside each JSON.
...
**4.7×**, respectively. See the [saved timings](reports/cpu_vs_gpu/benchmark.json)
